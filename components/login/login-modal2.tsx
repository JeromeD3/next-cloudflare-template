...
import { ChartBar, LogIn, LogOut, Settings } from 'lucide-react'
...
export default function LoginModal({ isCollapsed }: { isCollapsed: boolean }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button className={isCollapsed ? 'h-8 w-8 p-0' : ''}>
